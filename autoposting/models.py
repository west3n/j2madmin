...
class Autoposting(models.Model):
    moscow_time = datetime.datetime.now(pytz.timezone('Europe/Moscow')).strftime('%d.%m.%Y %H:%M')
    ...
    post_time = models.DateTimeField(
        verbose_name='Время поста', null=False, blank=False,
        help_text=f"Московское время: {moscow_time}")
